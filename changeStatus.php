    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!empty($_POST["Update"]))
        {
            ...
            if(empty($id_err) && empty($confirm_username_err)){
                ...
                $sql = "UPDATE users SET AdminB = 1 WHERE id = ?";
...
<html lang="en">
    ...
    <body class="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <h2>Change Users</h2>
        <p>
            Please fill in the details of the account you want to give admin status to.
        </p>
            ...
            <p>If you are looking to remove admin status see: <a href="changeBack.php" class="btn btn-warning">Change User Status</a></p>
        </div>
